...
class ProduitSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Produit
        fields = [
            'idProduit', 'nomProduit', 'quantiteDisponible', 'seuilCritique',
            'ration', 'unite', 'etat', 'nomFournisseur', 'nomCategorie', 'is_critical'
        ]
...
class ProduitEnvoieSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Produit
        fields = [
            'idProduit', 'nomProduit', 'quantiteDisponible',
            'seuilCritique', 'ration', 'unite', 'idFournisseur', 'idCategorie'
        ]
