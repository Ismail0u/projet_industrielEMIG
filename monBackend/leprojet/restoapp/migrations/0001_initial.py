# Generated by Django 5.1.5 on 2025-02-27 17:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateAjout', models.DateTimeField(blank=True, db_column='dateAjout', null=True)),
                ('unite', models.CharField(blank=True, db_column='unite', max_length=20, null=True)),
            ],
            options={
                'db_table': 'produit',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('MAGAZINIER', 'Magasinier'), ('RESPONSABLE_GUICHET', 'Responsable Guichet'), ('CHEF_SERVICE_RESTAURANT', 'Chef Service Restaurant'), ('ADMIN', 'Administrateur')], default='MAGAZINIER', max_length=30)),
